...
上述内容适合开发者DIY，我们提供技术github和bbs支持，购买方式参考[购买流程](./faq/buy.md)。

另外多说一句，开发并实施一套完整商用的IM系统是非常复杂和艰巨的。正常的开发环节包括需求分析、产品设计、架构设计、编码实现、单元测试、集成测试、上线测试。需要开发方与客户的大量的沟通，反复迭代产品设计和交互，需要重新定制UI和风格，实现特性化需求，进行大量的开发和测试，需要部署和实施等一系列工作，对各类技术人员要求也是很高的，需要项目经理，产品经理，UI设计师，各个端的研发人员，测试人员，运维人员，售后支持。我们野火IM只提供部分基础组件，不参与商业APP的研发和支持，甚至不提供电话和微信支持，所以野火的SDK只是完整的软件工程过程中的很小一部分，估计只能占到5%～10%的工作量。换句话说，我们提供的是部分原材料，提供的是沙子，不能依照沙子的价格来评估芯片或者楼房的价格。
