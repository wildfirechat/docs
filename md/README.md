...
> 开业促销，2019年专业版、PC SDK和Web SDK 五折促销。专业版、PC SDK和Web SDK会绑定机器码或域名。
...
| 管理后台 | 包括数据统计，用户管理，敏感词管理等，第二期会加入消息管理，群组管理，群发助手等，现在购买免费升级到二期功能。现有截图参考[后台管理](https://github.com/wildfirechat/admin/blob/master/README.md) | 1.5W（发布包）/3W（源码） |
