...
| [app_server](https://github.com/wildfirechat/app_server)     | [app_server](https://gitee.com/wfchat/app_server)     | 应用服务，提供登录换取IM Token等功能，可直接使用或移植到已有服务，含部分二次开发示例。                                                                                |
...
| [daily-report](https://github.com/wildfirechat/daily-report)   | [daily-report](https://gitee.com/wfchat/daily-report)   | 野火开放平台日报演示服务。
...
| [hm-chat](https://github.com/wildfirechat/hm-chat)         | [hm-chat](https://gitee.com/wfchat/hm-chat)         | 野火IM 鸿蒙NEXT 客户端应用源码。
...
| [wx-chat](https://github.com/wildfirechat/wx-chat)           | [wx-chat](https://gitee.com/wfchat/wx-chat)           | 小程序平台的客户端(支持微信、百度、阿里、字节、QQ 等小程序平台)                             |
