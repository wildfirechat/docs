...
7. 专业版支持国产化系统，支持任意国产CPU+国产操作系统，支持达梦金仓神通等国产数据库。详情参考[野火IM国产化适配状态](../blogs/野火IM国产化适配状态.md)和[国产化系统鲲鹏CPU+UOS适配经历](../blogs/国产化系统鲲鹏CPU+UOS适配经历.md)。
...
13. 专业版支持双网环境，可以用在内外网同时使用的双网环境。详情参考[政企内外双网解决方案](../blogs/政企内外双网解决方案.md)和[野火IM全球接入方案](../blogs/野火IM全球接入方案.md)。
14. 专业版支持超级群组功能，可以支持无限制群组大小。详情参考[超级群组](../blogs/超级群组.md)。
15. 专业版支持TCP短链接功能，可以用在禁止HTTP的环境中。详情参考[基于TCP的短链接](../blogs/基于TCP的短链接.md)。
