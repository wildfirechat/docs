...
## 5. 如何体验我们
Q：我想体验一下，怎么样能够体验到你们的产品？
A：可以现在我们发布的demo应用进行体验，也可以本地部署体验。
1. 使用发布的demo体验。iOS请在appstore搜索“野火IM”进行安装体验。android的请在[android发布包](https://github.com/wildfirechat/android-chat/releases)中下载最新安装版本。PC请在[PC发布包](https://github.com/wildfirechat/pc-chat/releases)中下载最新安装版本。
2. 也可以直接本地部署体验，请按照[快速开始](../quick_start/README.md)部署打包进行体验。
> PC是需要授权才能修改IM服务器地址，想体验的客户请下载我们的demo进行体验
