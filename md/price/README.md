...
| PC SDK | PC 端功能库，支持 Windows/macOS、国产化Linux、鸿蒙PC，技术栈可选，详见下方 [PC SDK](#pc-sdk) | - |
...
| 项目 | 支持平台 | 可选技术栈 | 价格 |
| ------ | ------ | ------ | ------ |
| PC SDK | Windows、macOS | Electron / C语言风格 / VC++、VC#（仅Windows） | 2.9W/套 |
| Linux PC SDK（国产化） | 国产化Linux，支持 X86_64/Arm64/龙芯/申威 架构 | Electron / C语言风格 | 2.9W/套/架构 |
| 鸿蒙 PC SDK | 鸿蒙PC | Electron / C语言风格 | 2.9W/套 |

各技术栈的区别如下，功能库均为闭源，但不影响二次开发：
...
| 落地电话 | 支持voip呼落地，落地呼voip，落地接入电话会议，依赖专业版IM服务和音视频高级版 | 5.9W/套 |
...
> 专业版IM服务和收费SDK都是终身授权的，另外包含一年的免费版本升级服务。可选延长升级服务，每年费用为产品价格的10%(购买2年赠送1年)。

> 对讲功能实现类似于对讲机功能，一方说话其他方实时播放，不同于语音消息的先录制后播放，一般用于公安/安保等场景。跟语音消息无关，免费版本包含语音消息功能。

> 以上价格含税，包含1%的增值税。

此外还提供***通配符域名授权***、***无限制授权*** 和 ***源码*** 三种授权方式，以满足高能力高要求客户的需求。当需要这些方式授权时可以联系我们。
